...
import { advanceGroupShortcutWheelGesture, emptyGroupShortcutWheelGesture, normalizeGroupShortcutWheelDeltaY, resolveShortcutKeyNavigationCommand } from '../src/collections/shortcutNavigation.ts'

describe('group shortcut navigation gestures', () => {
  it('maps vertical arrow keys to group navigation commands', () => {
    ...
    assert.equal(resolveShortcutKeyNavigationCommand('ArrowLeft'), null)
    assert.equal(resolveShortcutKeyNavigationCommand('ArrowRight'), null)
