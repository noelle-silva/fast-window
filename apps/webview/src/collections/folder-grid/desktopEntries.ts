...
import type { CollectionGridLayout, DesktopEntryKind, DesktopGridEntry, Workspace } from '../types'
...
export function buildDesktopGridEntries(workspace: Workspace, groupId: string): DesktopGridEntry[] {
...
export function filterDesktopGridEntries(workspace: Workspace, entries: DesktopGridEntry[], groupId: string, search: string): DesktopGridEntry[] {
