...
import type { Workspace, CollectionContainer, ContextMenuState, DesktopGridEntry, DesktopIconLayout, Phase } from '../types'
  ...
  return (
    <Paper elevation={0} sx={{ minHeight: '100%', p: { xs: 3, sm: 5 }, borderRadius: 4, display: 'grid', placeItems: 'center', textAlign: 'center', bgcolor: 'transparent', boxShadow: 'none' }}>
      <Stack spacing={1.5} alignItems="center" sx={{ maxWidth: 420 }}>
        ...
        <Button variant="contained" startIcon={<AddRoundedIcon />} onClick={props.onAdd} disabled={props.phase !== 'ready'}>添加{props.category.singularLabel}</Button>
      </Stack>
    </Paper>
  )
}
