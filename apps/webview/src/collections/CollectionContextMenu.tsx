...
function DesktopBlankMenuItems(props: {
  ...
  const actionDisabled = props.busy || !props.canEdit
  return (
    <React.Fragment>
...
function DesktopEntryMenuItems(props: {
  ...
  return (
    <React.Fragment>
      ...
      {item ? <MenuItem onClick={() => props.onEdit(item)}>
      ...
      {item ? <ItemGroupTransferControls busy={props.busy} groups={props.groups} item={item} onCopyToGroup={props.onCopyToGroup} onMoveToGroup={props.onMoveToGroup} /> : null}
      {item ? <ItemContainerControl doc={props.doc} item={item} onMoveToContainer={props.onMoveToContainer} /> : null}
...
function ContainerItemMenuItems(props: {
  ...
  return (
    <React.Fragment>
      ...
      <ItemContainerControl doc={props.doc} item={props.item} onMoveToContainer={props.onMoveToContainer} />
      <ItemGroupTransferControls busy={props.busy} groups={props.groups} item={props.item} onCopyToGroup={props.onCopyToGroup} onMoveToGroup={props.onMoveToGroup} />
  ...
  return (
    <Box sx={{ px: 2, py: 1, minWidth: 240, display: 'grid', gap: 1 }}>
      <FormControl variant="filled" fullWidth size="small" disabled={props.busy || !targetGroups.length}>
        <InputLabel id="context-move-group-label">移动到分组</InputLabel>
        <Select
          variant="filled"
      ...
      <FormControl variant="filled" fullWidth size="small" disabled={props.busy || !targetGroups.length}>
        <InputLabel id="context-copy-group-label">复制到分组</InputLabel>
        <Select
          variant="filled"
