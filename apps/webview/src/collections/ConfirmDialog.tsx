...
export function ConfirmDialog(props: { busy: boolean; confirm: ConfirmState; doc: WorkspaceView; onClose(): void; onConfirm(): void }) {
      ...
      <DialogContent sx={{ p: 3 }}>
        <Stack spacing={2.25}>
          ...
          <Stack direction="row" spacing={1} justifyContent="flex-end">
            ...
            <Button color="error" variant="contained" onClick={props.onConfirm} disabled={props.busy || groupCannotBeRemoved}>确认删除</Button>
          </Stack>
        </Stack>
      </DialogContent>
    </Dialog>
