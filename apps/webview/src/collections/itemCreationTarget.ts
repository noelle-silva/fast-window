import type { CollectionContainer, Workspace } from './types'
...
export function desktopItemCreationTarget(workspace: Workspace, preferredGroupId: string): ItemCreationTarget {
...
export function containerItemCreationTarget(workspace: Workspace, container: CollectionContainer): ItemCreationTarget {
...
export function assertItemCreationTarget(workspace: Workspace, target: ItemCreationTarget): void {
