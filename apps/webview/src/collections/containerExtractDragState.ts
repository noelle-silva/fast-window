...
import type { CollectionContainer, CollectionItem, Workspace, WorkspaceView } from './types'
...
export function applyContainerItemDesktopExtraction(workspace: Workspace, containerId: string, itemId: string, patches: DesktopGridLayoutPatch[]): Workspace {
...
export function applyContainerItemDesktopExtractionView(workspace: WorkspaceView, containerId: string, itemId: string, patches: DesktopGridLayoutPatch[]): WorkspaceView {
  return {
    ...workspace,
