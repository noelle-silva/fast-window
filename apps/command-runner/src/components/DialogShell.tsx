...
export function DialogShell({ title, subtitle, action, closeDisabled = false, children, onClose }: DialogShellProps) {
  return (
    <Dialog open onClose={closeDisabled ? undefined : onClose} fullWidth maxWidth="md" aria-labelledby="cr-dialog-title" PaperProps={{ className: 'cr-dialog' }}>
      <DialogTitle id="cr-dialog-title" className="cr-dialog-header" component="div">
        <Box sx={{ minWidth: 0 }}>
        ...
        <Box className="cr-dialog-actions">
          {action}
