...
export type Settings = { providers: Provider[]; activeProviderId: string; imageMaxCount: number; imageMaxMb: number; history: HistorySettings }
export type AppData = { version: 3; settings: Settings; spaces: Space[] }
