...
const SINGLE_INSTANCE_ADDR: &str = "127.0.0.1:45633";
const SINGLE_INSTANCE_TOKEN: &str = "fast-window-hypercortex-single-instance-v1";
...
pub(crate) fn start_single_instance_server(
    ...
    start_control_server(
        ...
        window_state,
        ControlServerConfig {
            name: "fw-hypercortex-single-instance",
