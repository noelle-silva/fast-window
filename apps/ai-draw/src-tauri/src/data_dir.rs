...
const CONFIG_FILE: &str = "ai-draw-settings.json";
const WRITE_TEST_FILE: &str = ".fw-ai-draw-write-test";
...
fn load_settings(app: &tauri::AppHandle) -> Result<AiDrawSettings, String> {
    let path = settings_path(app)?;
    if !path.is_file() {
        return Ok(AiDrawSettings::default());
    }
