...
const CONFIG_FILE: &str = "ai-knowledge-center-settings.json";
const WRITE_TEST_FILE: &str = ".fw-ai-knowledge-center-write-test";
...
fn load_settings(app: &tauri::AppHandle) -> Result<DataDirSettings, String> {
    let path = settings_path(app)?;
    if !path.is_file() {
        return Ok(DataDirSettings::default());
    }
