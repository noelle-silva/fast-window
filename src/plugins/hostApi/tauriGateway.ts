...
import { isTauriCommandAllowed } from './capability'
import type { PluginMethodDef, PluginMethodHandlerExtra, PluginMethodRegistry } from './types'
...
const tauriInvokeMethod: PluginMethodDef = {
...
const tauriStreamOpenMethod: PluginMethodDef = {
  handler: async (ctx: PluginContext, args: unknown[], extra: PluginMethodHandlerExtra) => {
...
const tauriStreamCancelMethod: PluginMethodDef = {
...
export const tauriGatewayMethods: PluginMethodRegistry = {
  'tauri.invoke': tauriInvokeMethod,
  'tauri.streamOpen': tauriStreamOpenMethod,
  'tauri.streamCancel': tauriStreamCancelMethod,
}
