...
export const LATEST_PLUGIN_API_VERSION = 3 as const
export const PLUGIN_API_VERSION = LATEST_PLUGIN_API_VERSION

export const SUPPORTED_PLUGIN_API_VERSIONS = [LEGACY_PLUGIN_API_VERSION, LATEST_PLUGIN_API_VERSION] as const
